...
const TOS_TEXT = `Chào mừng bạn đến với VoxelXLauncher. Bằng cách sử dụng phần mềm này, bạn đồng ý tuân thủ các điều khoản và điều kiện được nêu dưới đây. Vui lòng đọc kỹ trước khi tiếp tục sử dụng.

1. Chấp nhận điều khoản
Việc cài đặt, truy cập hoặc sử dụng VoxelXLauncher đồng nghĩa với việc bạn đồng ý bị ràng buộc bởi các Điều khoản Dịch vụ này. Nếu bạn không đồng ý với bất kỳ phần nào của các điều khoản này, bạn không được phép sử dụng phần mềm.

2. Giấy phép sử dụng
FoxStudio cấp cho bạn giấy phép cá nhân, không độc quyền, không thể chuyển nhượng và có thể thu hồi để sử dụng VoxelXLauncher cho mục đích cá nhân, phi thương mại. Bạn không được phép sao chép, sửa đổi, phân phối, bán hoặc cho thuê bất kỳ phần nào của phần mềm mà không có sự cho phép bằng văn bản của FoxStudio.
...
4. Hành vi bị cấm
Khi sử dụng VoxelXLauncher, bạn đồng ý không: (a) vi phạm bất kỳ luật hoặc quy định hiện hành nào; (b) sử dụng phần mềm để gian lận, hack hoặc can thiệp vào trải nghiệm của người chơi khác; (c) phân phối phần mềm độc hại hoặc mã độc; (d) cố gắng truy cập trái phép vào hệ thống hoặc mạng liên quan đến dịch vụ.

5. Quyền sở hữu trí tuệ
Tất cả nội dung, tính năng và chức năng của VoxelXLauncher, bao gồm nhưng không giới hạn ở văn bản, đồ họa, logo, biểu tượng và hình ảnh, đều là tài sản của FoxStudio và được bảo vệ bởi luật bản quyền, nhãn hiệu và các luật sở hữu trí tuệ khác.
...
8. Chấm dứt
FoxStudio có quyền chấm dứt hoặc đình chỉ quyền truy cập của bạn vào VoxelXLauncher ngay lập tức, mà không cần thông báo trước, vì bất kỳ lý do gì, bao gồm nhưng không giới hạn ở việc bạn vi phạm các Điều khoản Dịch vụ này.
...
const PRIVACY_TEXT = `Chính sách Quyền riêng tư này mô tả cách VoxelXLauncher và FoxStudio thu thập, sử dụng và chia sẻ thông tin về bạn khi bạn sử dụng phần mềm của chúng tôi.
...
Chúng tôi sử dụng thông tin thu thập được để: cung cấp, duy trì và cải thiện VoxelXLauncher; xử lý giao dịch và gửi thông báo liên quan; phản hồi các bình luận và câu hỏi; gửi thông tin kỹ thuật và cập nhật bảo mật; theo dõi và phân tích xu hướng sử dụng.
...
VoxelXLauncher lưu trữ dữ liệu tài khoản và cài đặt cục bộ trên máy tính của bạn tại thư mục %APPDATA%\.VoxelXClient. Bạn có toàn quyền kiểm soát dữ liệu này và có thể xóa bất cứ lúc nào.
...
VoxelXLauncher là ứng dụng desktop và không sử dụng cookie theo nghĩa truyền thống. Chúng tôi có thể sử dụng localStorage để lưu trữ cài đặt người dùng cục bộ.
    ...
    <div className="h-full overflow-y-auto px-6 py-5">
      ...
      `}>
        <div className={`
          ...
          ${bothAgreed ? 'bg-green-500/20' : 'bg-white/5'}
        `}>
          {bothAgreed ? (
