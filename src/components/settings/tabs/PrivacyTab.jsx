...
4. Hành vi bị cấm
Khi sử dụng VoxelXClient, bạn đồng ý không: (a) vi phạm bất kỳ luật hoặc quy định hiện hành nào; (b) sử dụng phần mềm để gian lận, hack hoặc can thiệp vào trải nghiệm của người chơi khác; (c) phân phối phần mềm độc hại hoặc mã độc; (d) cố gắng truy cập trái phép vào hệ thống hoặc mạng liên quan đến dịch vụ.

5. Quyền sở hữu trí tuệ
Tất cả nội dung, tính năng và chức năng của VoxelXClient, bao gồm nhưng không giới hạn ở văn bản, đồ họa, logo, biểu tượng và hình ảnh, đều là tài sản của FoxStudio và được bảo vệ bởi luật bản quyền, nhãn hiệu và các luật sở hữu trí tuệ khác.
...
8. Chấm dứt
FoxStudio có quyền chấm dứt hoặc đình chỉ quyền truy cập của bạn vào VoxelXClient ngay lập tức, mà không cần thông báo trước, vì bất kỳ lý do gì, bao gồm nhưng không giới hạn ở việc bạn vi phạm các Điều khoản Dịch vụ này.
...
const PRIVACY_TEXT = `Chính sách Quyền riêng tư này mô tả cách VoxelXClient và FoxStudio thu thập, sử dụng và chia sẻ thông tin về bạn khi bạn sử dụng phần mềm của chúng tôi.
...
Chúng tôi sử dụng thông tin thu thập được để: cung cấp, duy trì và cải thiện VoxelXClient; xử lý giao dịch và gửi thông báo liên quan; phản hồi các bình luận và câu hỏi; gửi thông tin kỹ thuật và cập nhật bảo mật; theo dõi và phân tích xu hướng sử dụng.
...
VoxelXClient lưu trữ dữ liệu tài khoản và cài đặt cục bộ trên máy tính của bạn tại thư mục %APPDATA%\.VoxelXClient. Bạn có toàn quyền kiểm soát dữ liệu này và có thể xóa bất cứ lúc nào.
...
VoxelXClient là ứng dụng desktop và không sử dụng cookie theo nghĩa truyền thống. Chúng tôi có thể sử dụng localStorage để lưu trữ cài đặt người dùng cục bộ.
